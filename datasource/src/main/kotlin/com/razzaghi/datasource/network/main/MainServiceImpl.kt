...
class MainServiceImpl(
    ...
    override suspend fun basketDelete(token: String, id: Int): MainGenericResponse<com.razzaghi.datasource.network.common.JRNothing?> {
        return httpClient.post {
            url {
                headers {
                    append(HttpHeaders.Authorization, token)
    ...
    override suspend fun like(token: String, id: Int): MainGenericResponse<com.razzaghi.datasource.network.common.JRNothing?> {
        return httpClient.get {
            url {
                headers {
                    append(HttpHeaders.Authorization, token)
